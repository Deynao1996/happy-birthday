...
const FlipTimer = () => {
  ...
  return (
    <div>
      ...
      <h4 className='text-center text-2xl tracking-tight my-4 mb-6'>Coming Soon...</h4>
      <div className="flex flex-col items-center justify-center w-full h-full gap-8 sm:gap-16">
        <div className="flex justify-center gap-3 sm:gap-8">
          <div className="flex flex-col gap-5 relative">
            <div className="h-16 w-16 sm:w-32 sm:h-32 lg:w-40 lg:h-40 flex justify-between items-center bg-foreground rounded-lg">
              <div className="relative h-2.5 w-2.5 sm:h-3 sm:w-3 !-left-[6px] rounded-full bg-background"></div>
              <span className="lg:text-7xl sm:text-6xl text-3xl font-semibold text-background">
                {hours < 10 ? `0${hours}` : hours}
              </span>
              <div className="relative h-2.5 w-2.5 sm:h-3 sm:w-3 -right-[6px] rounded-full bg-background"></div>
            </div>
            <span className="text-foreground text-xs sm:text-2xl text-center font-medium">
              Часов
            </span>
          </div>
          <div className="flex flex-col gap-5 relative">
            ...
            <span className="text-foreground text-xs sm:text-2xl text-center capitalize">
              Минут
            </span>
          </div>
          <div className="flex flex-col gap-5 relative">
      ...
      <Button asChild
        ...
        >
          ...
          Перейти
          <TriangleRightIcon className='ml-2' />
          </Link>
        </Button>
    </div>
  )
